...
This deploys the llm-d Router in the simple [Standalone Mode](../../docs/architecture/core/router/proxy.md#standalone-mode). The release name `${GUIDE_NAME}` is mandatory — the inference pool selector matches a guide label that pairs with this release.
